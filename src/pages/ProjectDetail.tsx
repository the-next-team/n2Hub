    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
        ...
        <Link
          ...
          className="flex items-center gap-4 bg-white rounded-xl border border-gray-200 p-5 hover:border-purple-300 hover:shadow-sm transition-all"
        >
          <div className="p-3 bg-purple-50 rounded-lg text-purple-600">
            <Users size={20} />
          </div>
          <div>
            <div className="font-medium text-gray-900">멤버 관리</div>
            <div className="text-sm text-gray-500 mt-0.5">팀원 추가 및 역할 설정</div>
          </div>
          <ChevronRight size={16} className="text-gray-300 ml-auto" />
        </Link>
      </div>
